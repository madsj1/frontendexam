...
namespace FrontEndExam.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Poster,Description,ReleaseDate,Genre,Price")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Title,Poster,Description,ReleaseDate,Genre,Price")] Movie movie)
        {
            if (ModelState.IsValid)
            {
